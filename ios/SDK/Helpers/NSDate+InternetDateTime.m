...
{
    // 2012-03-26T09:44:43.125-04:00
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.SSSZZZ"];
    NSString *rawDate = [dateFormatter stringFromDate:self];
    NSMutableString *mutatedString = [NSMutableString stringWithString:rawDate];
    [mutatedString insertString:@":" atIndex:rawDate.length-2];
    return [NSString stringWithString:mutatedString];
}
@end
